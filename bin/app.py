...
class App:
    ...
    def generar_arreglo_base(self, tamaño_maximo):
        # Generar un arreglo aleatorio de tamaño máximo
        return [random.randint(1, 10000) for _ in range(tamaño_maximo)]

    def ejecutar_pruebas(self):
        # Diccionarios para almacenar tiempos de cada método
        ...
        for tamaño in self.tamaños:
            # Tomar los primeros 'tamaño' elementos del arreglo base
            arreglo_original = self.arreglo_base[:tamaño]
            
            # Probar Bubble Sort Mejorado
            arreglo_bubble = arreglo_original.copy()  # Clonar el arreglo
            ...
            arreglo_burbuja = arreglo_original.copy()  # Clonar el arreglo
            ...
            arreglo_selection = arreglo_original.copy()  # Clonar el arreglo
            ...
            # Probar Shell Sort
            arreglo_shell = arreglo_original.copy()  # Clonar el arreglo
            ...
            arreglo_insercion = arreglo_original.copy()  # Clonar el arreglo
        ...
        # Crear el gráfico de los tiempos
